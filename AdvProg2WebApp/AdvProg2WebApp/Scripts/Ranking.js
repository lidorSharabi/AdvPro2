...
function compareByRank(a, b) {
    if (a.Victories - a.Losses < b.Victories - b.Losses)
        return 1;
    if (a.Victories - a.Losses > b.Victories - b.Losses)
        return -1;
    return 0;
...
//    var usersTableStr = localStorage.getItem('usersArray');
//    var usersDetials = usersTableStr.split(",");
//    var length = usersDetials.length;
//    var users = [[]];
//    for (index = 0; index < length; ++index) {
//        var currentSet = 4 * index;
//        users[index] = [usersDetials[currentSet], usersDetials[currentSet + 1], usersDetials[currentSet + 2], usersDetials[currentSet + 3]];
//    }
//    $('#example').DataTable({
//        data: users,
//        columns: [
